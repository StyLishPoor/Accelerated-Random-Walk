...
class Graph{
  public:
    ...
    void Accelerated(int sourceNode, double alpha, double W, double rmax);
    ...
    void Remedy(int sourceNode, double alpha, double W);
    void Accelerated_Remedy(int sourceNode, double alpha, double W);
};
